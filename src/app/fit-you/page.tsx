      ...
      <section className="px-4 py-16 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-xl rounded-2xl p-8">
            <Image src="/fit-you/step1.png" width={500} height={300} alt="Step 1" className="mx-auto mb-4 w-24 h-24 object-contain" />
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-xl rounded-2xl p-8">
            <Image src="/fit-you/step2.png" width={500} height={300} alt="Step 2" className="mx-auto mb-4 w-24 h-24 object-contain" />
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-xl rounded-2xl p-8">
            <Image src="/fit-you/step3.png" width={500} height={300} alt="Step 3" className="mx-auto mb-4 object-contain" />
